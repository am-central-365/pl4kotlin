...
abstract class BaseStatement(val entityDef: Entity, private val getGoodConnection: () -> Connection?) {
     ...
     *  while building the statement. Separating [build] and [run] could lead to inconsistency if
     *  property values change between the calls.
     */
    ...
    /** Bind [vals] to the [stmt] choosing proper bind function, corresponding to the value */
